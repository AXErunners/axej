...
public class MonetaryFormatTest {
    ...
    public void standardCodes() throws Exception {
        assertEquals("AXE 0.00", MonetaryFormat.BTC.format(Coin.ZERO).toString());
        assertEquals("mAXE 0.00", MonetaryFormat.MBTC.format(Coin.ZERO).toString());
        assertEquals("µAXE 0", MonetaryFormat.UBTC.format(Coin.ZERO).toString());
    }

    @Test
    public void customCode() throws Exception {
        assertEquals("dAXE 0", MonetaryFormat.UBTC.code(1, "dAXE").shift(1).format(Coin.ZERO).toString());
    }
    ...
    public void noCode() throws Exception {
        ...
        assertEquals("dAXE 0", MonetaryFormat.UBTC.noCode().code(1, "dAXE").shift(1).format(Coin.ZERO).toString());
    }

    @Test
    public void codeOrientation() throws Exception {
        assertEquals("AXE 0.00", MonetaryFormat.BTC.prefixCode().format(Coin.ZERO).toString());
        assertEquals("0.00 AXE", MonetaryFormat.BTC.postfixCode().format(Coin.ZERO).toString());
    }

    @Test
    public void codeSeparator() throws Exception {
        assertEquals("AXE@0.00", MonetaryFormat.BTC.codeSeparator('@').format(Coin.ZERO).toString());
    }
