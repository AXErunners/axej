...
/**
 * A tool for comparing the blocks which are accepted/rejected by axed/axej
 * It is designed to run as a testnet-in-a-box network between a single axed node and axej
...
public class BitcoindComparisonTool {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("USAGE: axejBlockStoreLocation runExpensiveTests(1/0) [port=18444]");
