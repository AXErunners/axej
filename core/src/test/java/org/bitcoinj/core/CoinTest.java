...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 AXE", COIN.toFriendlyString());
        assertEquals("1.23 AXE", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 AXE", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 AXE", valueOf(1, 23).negate().toFriendlyString());
    }
