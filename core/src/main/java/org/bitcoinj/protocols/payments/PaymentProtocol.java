...
public class PaymentProtocol {
    ...
    public static final String MIMETYPE_PAYMENTREQUEST = "application/axe-paymentrequest";
    public static final String MIMETYPE_PAYMENT = "application/axe-payment";
    public static final String MIMETYPE_PAYMENTACK = "application/axe-paymentack";
