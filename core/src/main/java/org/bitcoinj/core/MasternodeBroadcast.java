    ...
    boolean checkOutpoint(Dos nDos)
    {
...

        {
            ...
            if (err == COLLATERAL_INVALID_AMOUNT) {
                log.info("masternode--CMasternodeBroadcast::CheckOutpoint -- Masternode UTXO should have 1000 AXE, masternode={}", info.outpoint.toStringShort());
                return false;
            }
        ...
        // should be at least not earlier than block when 1000 AXE tx got nMasternodeMinimumConfirmations
        ...
        GetTransaction(vin.prevout.hash, tx2, Params().GetConsensus(), hashBlock, true);
        {
            ...
            if (mi != mapBlockIndex.end() && (*mi).second) {
                CBlockIndex* pMNIndex = (*mi).second; // block for 1000 AXE tx -> 1 confirmation
