...
public abstract class NetworkParameters {
    ...
    public static final String ID_DEVNET = "org.axe.dev";
    /** Unit test network. */
     ...
     *
     * <p>The second block in a devnet chain is a known constant shared between all Axe DevNet implimentations for a
